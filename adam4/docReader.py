...
def get_product_group(text):
    haystack = text[text.find("Uso y aplicaciones del producto de apoyo") + 40 : text.find("ISO 9999")]

    movilidad = "Es apoyo para la movilidad: ("
    educativo = ") Entorno educativo: ("
    recreacion = ""
...
def main():
    ...
    check_iso_products(productMatrix)
